...
from signguard.core.types import ModelUpdate, SignedUpdate, ClientConfig
from signguard.crypto.signature import SignatureManager
from signguard.utils.serialization import serialize_model
...
class SignGuardClient:
    ...
    def load_model(self, filepath: str) -> None:
        ...
        """
        from signguard.utils.serialization import deserialize_model
