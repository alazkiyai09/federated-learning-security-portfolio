...
def main():
    ...
    if page == "⚡ Training Monitor":
        # Import page
        from app.pages.training_monitor import show_page
        show_page()

    elif page == "👥 Client Analytics":
        from app.pages.client_analytics import show_page
        show_page()

    elif page == "🛡️ Security Status":
        from app.pages.security_status import show_page
        show_page()

    elif page == "🔐 Privacy Budget":
        from app.pages.privacy_budget import show_page
        show_page()

    elif page == "📊 Experiment Comparison":
        from app.pages.experiment_comparison import show_page
        show_page()
