...
from signguard.utils.metrics import compute_accuracy
...
class SignGuardServer:
    ...
    def save_checkpoint(
        ...
        """
        from signguard.utils.serialization import save_checkpoint
        save_checkpoint(
            round_num=self.current_round,
    ...
    def load_checkpoint(
        ...
        """
        from signguard.utils.serialization import load_checkpoint
