...
from signguard.core.types import ServerConfig
from signguard.attacks import ModelPoisonAttack
from signguard.utils.visualization import plot_ablation_study
from signguard.utils.metrics import compute_accuracy, compute_attack_success_rate
...
class CustomServer:
    ...
    def aggregate(self, updates, global_params):
        ...
        # Aggregate
        from signguard.core.types import AggregationResult
        aggregated_params = {}
